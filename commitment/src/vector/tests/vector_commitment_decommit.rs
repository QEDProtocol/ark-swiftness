...
fn test_vector_commitment_decommit() {
    let commitment: Commitment<Fp> = Commitment {
        config: Config {
        ...
        commitment_hash: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
    ...
    let queries = vec![
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x73")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x12346ea425a6aebc8c323a401410cc325aabaf99b54e600a7271f146488aa2d",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0xa5")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x1aabe006a27bfa5f93bde192ff552adbef87058e62546c831ed14ce94866ac1",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0xb0")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x7205a2b5f5f403b8053b4e4ac65e2a484c007f6d118524fe28b7cdf2a56bb8a",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0xf8")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x5d49462d844a3f203c59d39fa005cbe153c78e6ac831987f19c0d6dfae38fad",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x115")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x53d21587a9cb08d1b9402a4b8c2a9d37942b26963936200fea3122eaaf870b1",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x11c")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x7c3355a75f6b36a95068b68d48e7539cd97531b7478e2cf7d2dc85b32bafc66",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x12f")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0xb6f3a522577229ac26f12df90daaf376afbd960ee4b0ab07f270bf9c5da56a",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x13c")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x174cfc44eb57da0eda6ae9407db71c5144940f05ef51f858bc8e229d15703e2",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x153")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
                "0x2220da78b33e155482bdf0534dc30fc17fe059a7b9e30f710ee2681a8151484",
            )),
        },
        Query {
            index: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked("0x1f4")),
            value: StarkArkConvert::from_stark_felt(Felt::from_hex_unchecked(
