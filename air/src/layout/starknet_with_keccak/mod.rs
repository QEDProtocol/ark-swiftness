...
impl<F: SimpleField + PoseidonHash> LayoutTrait<F> for Layout {
    ...
    fn eval_composition_polynomial(
        ...
        let n_keccak_component_copies = n_steps.field_div(&
            F::from_constant((DILUTED_N_BITS * KECCAK_RATIO) as u128),
        );
        // assert!(n_keccak_component_copies < u128::MAX.into());
        n_keccak_component_copies.assert_lt(&F::from_constant(u128::MAX));
        let n_keccak_periodic_columns_copies = F::from_constant(2048_u128) * n_keccak_component_copies;
            ...
            From<Boolean<<P::BaseField as Field>::BasePrimeField>>
    {
        ...
        let program_hash = PedersenHash::<P>::hash(hash.clone(), F::from_constant(program.len() as u128));
        ...
        let output_hash = PedersenHash::<P>::hash(hash.clone(), F::from_constant(output_len as u128));
