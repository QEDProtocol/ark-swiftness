    ...
    FriDecommitment {
        values: vec![
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x2523e038745ae98d2f3963c4fa90874759a0000f48a39df5c4265c31dbb69c3",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x62f6ce7fd1cdb1cdd21d4cab536d6bdf765d3a13855db4bed360fcbc300fc8",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x291fbdae4ff4477ec9436c1867d8593c75bd757a3b84a311f4e94d6fa6b3010",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x79f2106549802941006268dfe95ebd6531d317cdd34aa8aecfd06b99d25ca9b",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x80aa04db0dbb3c0dd25dacdf2d9d0b3bf71cee929b3b9c095628bdb6e8a575",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
        ...
        points: vec![
            F::from_stark_felt(Felt::from_hex_unchecked(
                "0x3a119fd1841a8ef246e57f4d032b68478c70a37d3123c33bd64c0c54089e514",
            )),
            F::from_stark_felt(Felt::from_hex_unchecked(
