...
fn test_next_layer1() {
    let mut queries = vec![FriLayerQuery {
        index: Fp::from_stark_felt(Felt::from_dec_str("19").unwrap()),
        y_value: Fp::from_stark_felt(
            Felt::from_dec_str(
                "3009640132648008425771663319959959262486220333099664427328058765768842449250",
            )
            .unwrap(),
        ),
        x_inv_value: Fp::from_stark_felt(
            Felt::from_dec_str(
    ...
    let mut sibling_witness = vec![Fp::from_stark_felt(
        Felt::from_dec_str(
...
fn test_next_layer5() {
    ...
    let expected_verify_indices = vec![
        Fp::from_stark_felt(Felt::from(0)),
        Fp::from_stark_felt(Felt::from(4)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
            Felt::from_dec_str(
...
fn test_next_layer6() {
    ...
    let expected_verify_indices = vec![
        Fp::from_stark_felt(Felt::from(1)),
        Fp::from_stark_felt(Felt::from(4)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
...
fn test_next_layer7() {
    ...
    let expected_verify_indices = vec![
        Fp::from_stark_felt(Felt::from(0)),
        Fp::from_stark_felt(Felt::from(3)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
            Felt::from_dec_str(
...
fn test_next_layer9() {
    ...
    let expected_verify_indices = vec![
        Fp::from_stark_felt(Felt::from(5)),
        Fp::from_stark_felt(Felt::from(14)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
            Felt::from_dec_str(
...
fn test_next_layer13() {
    ...
    let expected_verify_indices = vec![
        ...
        Fp::from_stark_felt(Felt::from(3)),
        Fp::from_stark_felt(Felt::from(8)),
        Fp::from_stark_felt(Felt::from(9)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
            Felt::from_dec_str(
...
fn test_next_layer14() {
    ...
    let expected_verify_indices = vec![
        Fp::from_stark_felt(Felt::from(0)),
        Fp::from_stark_felt(Felt::from(6)),
        Fp::from_stark_felt(Felt::from(7)),
    ];
    let expected_verify_y_values = vec![
        Fp::from_stark_felt(
            Felt::from_dec_str(
